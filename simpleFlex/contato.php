  ...
  <body>
    ...
    <section class="flexcontact text-center">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          <img src="images/fotoefeitos.com_.jpg" class="img-circle" alt="Flexliper empresa de TI" width="135" height="135"> <img src="images/flexsuporte.jpg" class="img-circle" alt="Flexliper empresa de TI" width="135" height="135">
    ...
    <footer style="margin-top: 20px;"><p>Todos os direitos reservados - contato@flexliper.com.br</p></footer>
